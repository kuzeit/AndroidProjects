...
public class AddLike {
        ...
        public static void getData(Context context , int item_id) {
            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, URLs.LIKE, params, new Response.Listener<JSONObject>() {
                @Override
                public void onResponse(JSONObject response) {

                        Toast.makeText(context, "okk like", Toast.LENGTH_SHORT).show();
