...
public class Rating {
    ...
    public static void getData(Context context, float  point , int designer_id) {
        ...
        try {
            params.put("order_id", designer_id);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, URLs.RATING, params, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {

                Toast.makeText(context, "okk rating", Toast.LENGTH_SHORT).show();
