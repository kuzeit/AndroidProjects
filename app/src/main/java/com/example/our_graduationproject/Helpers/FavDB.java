...
//            + LIKES + " TEXT,"+ ITEM_IMAGE + " TEXT," + FAVORITE_STATUS+" TEXT)";
//
...
//    public void insertIntoTheDatabase(String item_title, String item_image, int id, String fav_status,String Likes) {
//        SQLiteDatabase db;
